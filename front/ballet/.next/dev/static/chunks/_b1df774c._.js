...
function AuthProvider(t0) {
    ...
    if ($[0] !== "e6749e1088649b34bdee01913504ee7ca5aef7de059f35dc8f03aad1c3d26c5a") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e6749e1088649b34bdee01913504ee7ca5aef7de059f35dc8f03aad1c3d26c5a";
    }
    const { children } = t0;
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "AuthProvider[login]": (newUser, newUserData)=>{
                setUser(newUser);
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "AuthProvider[updateUser]": (newUser_0, newUserData_0)=>{
                setUser(newUser_0);
                setUserData(newUserData_0);
                localStorage.setItem("ballet_user", JSON.stringify(newUser_0));
                localStorage.setItem("ballet_user_data", newUserData_0);
            }
    ...
    const updateUser = t5;
    let t6;
    if ($[6] !== isLoading || $[7] !== user || $[8] !== userData) {
        t6 = {
            user,
            userData,
            isLoading,
...
_s(AuthProvider, "KVScBt1VEaoGwmv59qqLw6/ZYE8=");
_c = AuthProvider;
function useAuth() {
    _s1();
